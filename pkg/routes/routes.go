...
func NewMuxRoute(taskHandler handlers.TaskHandler, accountHandler handlers.AccountHandler) *mux.Router {
	r := mux.NewRouter()
	...
	r.HandleFunc("/registration", accountHandler.CreateAccount).Methods("POST")
